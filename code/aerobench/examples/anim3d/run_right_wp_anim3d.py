...
from visualize import anim3d, plot
...
def simulate(filename):
    ...
    waypoints = [[e_pt, n_pt, h_pt],
                 [e_pt + 1000, n_pt+2000, h_pt],
                 [e_pt+2000 , n_pt +5000, h_pt ],
                 [e_pt+7000, n_pt + 12000, h_pt ],
		 [e_pt +15000, n_pt +20000, h_pt ],
		 [e_pt +35000, n_pt +25000, h_pt ]]
